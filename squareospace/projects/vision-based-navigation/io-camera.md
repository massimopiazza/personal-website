...
Between 2021 and 2023, I've had substantial end-to-end ownership in the development of a high-performance space-grade camera with edge processing capabilities enabled by:
- _PolarFire_ SoC (_RISC-V_ processor + _Microsemi_ FPGA)
- high quantum efficiency COTS detector (CMOS type)
